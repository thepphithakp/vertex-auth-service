...
//
// auth-service ต้องเข้มที่สุดในสาม service เพราะจัดการ password และ
// token โดยตรง — พลาดจุดนี้จุดเดียวคือรหัสผ่านผู้ใช้หลุดเข้า Elasticsearch
var sensitiveFields = []string{
	"password", "passwordhash", "password_hash",
	"idtoken", "id_token", "token", "accesstoken", "access_token",
	"refreshtoken", "refresh_token", "secret", "authorization",
	// email เป็น PII แม้ไม่ใช่ความลับเชิงระบบ แต่ไม่ควรให้ log
	// เป็นสำเนาที่สองของฐานข้อมูลผู้ใช้
	"email",
}
